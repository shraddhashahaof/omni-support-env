...
#     if action_type in useful_tools:
#         reward += 0.05
...
#     if (
#         "refund" in ticket_text
#         and action_type == "lookup_order"
#     ):
#         reward += 0.15

#     if (
#         "refund" in ticket_text
#         and action_type == "check_account"
#     ):
#         reward += 0.15

#     if (
#         "refund" in ticket_text
#         and action_type == "process_refund"
#     ):
#         reward += 0.25

#     if (
#         "password" in ticket_text
#         and action_type == "check_account"
#     ):
#         reward += 0.20

#     if (
#         "fraud" in ticket_text
#         and action_type == "flag_security"
#     ):
#         reward += 0.30

#     if (
#         "chargeback" in ticket_text
...
#     if tools_used_so_far.count(action_type) > 1:
#         reward -= 0.10
...
#     if len(violations_so_far) > 0:
#         reward -= 0.20 * len(violations_so_far)

#     # =========================
#     # USEFUL RESPONSE BONUS
#     # =========================

#     if action_type == "send_response":

#         if len(action_value) > 30:
#             reward += 0.10
#         else:
#             reward -= 0.05
...
#     # =========================
#     # INVALID CLOSE PENALTY
#     # =========================

#     if action_type == "close_no_action":
#         reward -= 0.25
